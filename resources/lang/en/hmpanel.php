...
return [
    ...
    */
    ...
    'server_setup_step7' => 'HmPanel doesn\'t work with NAT VPN and OpenVZ or in localhost',
    'server_setup_step8' => 'Before install HmPanel, please make sure your server is a clean Ubuntu 20.04 LTS VPS',
    ...
    'reset_hmpanel_password' => 'Reset HmPanel user password',
    'require_reset_hmpanel_password' => 'Require Reset',
    'hd_memory_usage' => 'HD Memory Usage',
    'hmpanel_build_version' => 'HmPanel Build Version',
    ...
    'require_password_reset_modal_text' => 'Are you sure to reset HmPanel user password?',
    'new_password_success' => 'New HmPanel user password',
