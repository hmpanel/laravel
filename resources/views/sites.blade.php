            ...
            <div class="card mb-4">
                <div class="card-header text-right">
                    <button class="btn btn-sm btn-secondary" id="newSite">
                        <i class="fas fa-plus mr-1"></i><b>{{ __('hmpanel.new_button', ['type' => __('hmpanel.site')]) }}</b>
                    </button>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dt" width="100%" cellspacing="0">
                            <thead>
                            <tr>
                                <th class="text-center">{{ __('hmpanel.domain') }}</th>
                                <th class="text-center text-center d-none d-md-table-cell">{{ __('hmpanel.aliases') }}</th>
                                <th class="text-center d-none d-lg-table-cell">{{ __('hmpanel.server') }}</th>
...
@section('extra')
        ...
        <div class="modal-dialog" role="document" id="newsitedialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="newSiteModalLabel">{{ __('hmpanel.new_site_modal_title') }}</h5>
                ...
                <div class="modal-body">
                    <div id="newsiteform">
                        <label for="newsitedomain">{{ __('hmpanel.site_domain') }}</label>
                        <div class="input-group">
                            <input class="form-control" type="text" id="newsitedomain" placeholder="e.g. domain.ltd" autocomplete="off" />
                        </div>
                        <div class="space"></div>
                        <label for="newsiteserver">{{ __('hmpanel.server') }}</label>
                        <div class="input-group">
                            <select class="form-control" id="newsiteserver"></select>
                        </div>
                        <div class="space"></div>
                        <label for="newsiteprovider">{{ __('hmpanel.php_version') }}</label>
                        <div class="input-group">
                        ...
                        <div class="space"></div>
                        <label for="newsitebasepath">{{ __('hmpanel.site_base_path') }}</label>
                        <div class="input-group">
                    ...
                    <div id="newsiteok" class="d-none container">
                        <div class="row">
                            <div class="col-xs-12">
                                <p><b>{{ __('hmpanel.site_ready_message') }}</b></b>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-12">
                                <p>{{ __('hmpanel.domain') }}:<br><b><span id="newsitedomainok"></b></b></p>
                                <p>{{ __('hmpanel.server_ip') }}:<br><b><span id="newsiteip"></b></b></p>
                                <p>SSH {{ __('hmpanel.username') }}:<br><b><span id="newsiteusername"></b></p>
                                <p>SSH {{ __('hmpanel.password') }}:<br><b><span id="newsitepassword"></b></p>
                                <p>MySQL {{ __('hmpanel.database') }}:<br><b><span id="newsitedbname"></b></p>
                                <p>MySQL {{ __('hmpanel.username') }}:<br><b><span id="newsitedbusername"></b></p>
                                <p>MySQL {{ __('hmpanel.password') }}:<br><b><span id="newsitedbpassword"></b></p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-12">
                                <p>{{ __('hmpanel.document_root') }}:<br><b>/home/<span id="newsitebasepathuser"></span>/web/<span id="newsitebasepath"></b></p>
                            </div>
                        </div>
                        <div class="space"></div>
                        <div class="row">
                            <div class="col-xl-12 text-center">
                                <a href="" target="_blank" id="newsitepdf">
                                    <button class="btn btn-success" type="button"><i class="fas fa-file-pdf"></i> {{ __('hmpanel.download_site_data') }}</button>
                                </a>
                            </div>
                        </div>
                        <div class="space"></div>
    ...
    <div class="modal fade" id="deleteSiteModal" tabindex="-1" role="dialog" aria-labelledby="deleteSiteModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteSiteModalLabel">{{ __('hmpanel.delete_site_modal_title') }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
