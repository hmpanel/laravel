...
sudo rpl -i -w "HMPANELSERVERID" $SERVERID /var/www/html/database/seeders/DatabaseSeeder.php
sudo rpl -i -w "HMPANELIP" $IP /var/www/html/database/seeders/DatabaseSeeder.php
sudo rpl -i -w "HMPANELPASS" $PASS /var/www/html/database/seeders/DatabaseSeeder.php
sudo rpl -i -w "HMPANELDB" $DBPASS /var/www/html/database/seeders/DatabaseSeeder.php
...
cd /var/www/html && php artisan hmpanel:activesetupcount
HMPANELBULD=/var/www/html/public/build_$SERVERID.php
sudo touch $HMPANELBULD
sudo cat > $HMPANELBULD <<EOF
$BUILD
EOF
HMPANELPING=/var/www/html/public/ping_$SERVERID.php
